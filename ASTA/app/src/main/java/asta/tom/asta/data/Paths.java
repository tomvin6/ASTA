...
public final class Paths {
    // internal folders:
    public final static String INTERNAL_MAIN_FOLDER_NAME = "/FieldTestTool";
    ...
    public final static String INTERNAL_TASKS_FOLDER = INTERNAL_SYSTEM_FOLDER + "Tasks";
    public final static String TASK_FOLDER = "Task";
    ...
    public static final String INTERNAL_RESULTS_DATA = INTERNAL_MAIN_FOLDER +
            "Results/";
    public static final String INTERNAL_TCPDUMP_FOLDER = INTERNAL_RESULTS_DATA +
            "TCPDump/";
    // external (FTP SERVERS) folders:
    public final static String SERVER_MAIN_FOLDER = "/FieldTestTool/";
