 ...
 */
public class FtpTaskRunnerActivity extends TaskRunnerActivity {
    ...
    protected void stopTaskService() {
        Intent testIntent = new Intent(
                FtpTaskRunnerActivity.this, FtpTaskRunner.class);
    ...
    protected void specialSettingsByTaskType() {
        m_oULSessionParams.setEnabled(false);
        m_oDNSessionParams.setEnabled(false);
        m_oDNSession.setEnabled(false);
        m_oULSessionParams.setEnabled(false);
        m_oULSession.setEnabled(false);
        m_oBufferSize.setEnabled(false);
        m_oBuffer.setEnabled(false);
    }
    // initialize server intent:
    protected void initializeServerIntent() {
        m_iNewServerIntent = new Intent(
                FtpTaskRunnerActivity.this, NewServerActivity.class);
    }
    /**
    ...
    protected void runButtonPressed() {
        m_oStatusScreen = new Intent(FtpTaskRunnerActivity.this,
