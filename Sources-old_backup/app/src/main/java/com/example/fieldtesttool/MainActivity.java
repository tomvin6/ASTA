...
import com.example.Task.FtpTaskRunnerActivity;
import com.example.Task.NttTaskRunnerActivity;
import com.example.Task.TCPDumpProcess;
...
public class MainActivity extends ListActivity {
    private static final String NEW_FTP_TASK = "New FTP task";
    private static final String NEW_NTT_TASK = "New NTT task";
    private static final String SETTINGS = "Settings";
    private static final String LAST_RESULTS = "Last Results";
    private static final String APPLICATION_TITLE = "Field Test Tool";
    ...
    public void onCreate(Bundle bundle) {
        ...
        setVersionNameOnFooter(lv, inflater);
    }
    ...
    private void setVersionNameOnFooter(ListView lv, LayoutInflater inflater) {
        ...
        Logger.write("Application version: " + version, this);
    }
    /**
    ...
    private void initializeDeviceHeirarchy() {
        ...
        // TCP Dump folder
        File l_oTcpDumpDirectory = new File(Environment
                .getExternalStorageDirectory() +
                Paths.INTERNAL_TCPDUMP_FOLDER);
        if (!l_oTcpDumpDirectory.exists()) {
            l_oTcpDumpDirectory.mkdirs();
            Log.d(TAG, "TCP dump folder doesn't exist");
        }
        // downloads folder
    ...
    private void openFirstRunningDialog() {
        ...
        builder.setPositiveButton(GET_APP_FILES, new DialogInterface.OnClickListener
            ...
            public void onClick(DialogInterface dialog, int which) {
                new downloadDeviceFiles(MainActivity.this).execute("");
                dialog.dismiss();
            }
        });
    ...
    private ArrayList<MenuModel> generateData() {
        ...
        models.add(new MenuModel(R.drawable.action_help, NEW_FTP_TASK));
        models.add(new MenuModel(R.drawable.action_help, NEW_NTT_TASK));
        models.add(new MenuModel(R.drawable.settings_icon, SETTINGS));
        models.add(new MenuModel(R.drawable.results_icon, LAST_RESULTS));
        models.add(new MenuModel(R.drawable.get, GET_APP_FILES));
        models.add(new MenuModel(R.drawable.task_icon, MANAGE_SERVERS));
        //models.add(new MenuModel(R.drawable.task_icon, "tcpdump test"));
        return models;
    }
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (position) {
            case 1: //new Task
                Intent ftpTask = new Intent(MainActivity.this, FtpTaskRunnerActivity.class);
                startActivity(ftpTask);
                break;
            case 2: //New job
                Intent nttTask = new Intent(MainActivity.this,
                        NttTaskRunnerActivity.class);
                startActivity(nttTask);
                break;
            case 3: //Settings
                ...
                break;
            case 4: // last results
                Intent lastResults = new Intent(MainActivity.this,
            ...
            case 5: // last results
                ...
                */
                ...
                break;
            case 6: //manage servers
                Intent manageServersActivity = new Intent(MainActivity
                        .this,
                        ManageServersActivity.class);
                startActivity(manageServersActivity);
                break;
            /*
            case 7: //manage servers
                TCPDumpProcess t = new TCPDumpProcess();
                t.onStartCommand();
                break;
                */
        }
    ...
    class downloadDeviceFiles extends AsyncTask<String, Integer, String> {
        ...
        protected String doInBackground(String... f_url) {
            if (Validator.isNetworkAvailable(MainActivity.this) && !isProcessRunning) {
                        ...
                        for (final String fName : fileNames) {
                            ...
                            if (!curDownloadFile.exists() && !curServerFile.exists()) {
                                ...
                                runOnUiThread(new Runnable() {
                                    public void run() {
                                        Toast.makeText(MainActivity.this, "Got " + fName +
                                                " File", Toast
                                                .LENGTH_SHORT).show();
                                    }
                                });
        ...
        protected void onPostExecute(String status) {
            ...
            Toast.makeText(MainActivity.this, status, Toast
                    .LENGTH_SHORT).show();
        }
    }
}
