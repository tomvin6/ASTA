...
public abstract class TaskRunnerActivity extends Activity implements OnClickListener {
    ...
    // GUI objects:
    protected Spinner m_oServersSpinner, m_oModeSpinner,
            m_oNetworkTypeSpinner, m_oIteration,m_oLimitationQuantity,
            mProtocolSpinner;
    protected Button m_oNewServer, m_oRun, m_bStatus;
    protected CheckBox m_oTCPDump;
    protected EditText m_oOtherTime, m_oTaskName;
    protected TextView m_oServerParams, m_oModeParams, m_oLimitParams, m_oLimitType,
            m_oNetworkType, m_oDNSessionParams, m_oIterationsParams, m_oBuffer,
    ...
    public void initialize() {
        ...
        m_oModeParams = (TextView) findViewById(R.id.result_text);
        // limit
        m_oLimitationQuantity = (Spinner) findViewById(R.id.limit_insert_text);
        //m_oLimitType = (TextView) findViewById(R.id.limit_end);
        // network type
        m_oNetworkType = (TextView) findViewById(R.id.network_type_text);
        m_oDNSessionParams = (TextView) findViewById(R.id.dl_session_param);
        m_oNetworkTypeSpinner = (Spinner) findViewById(R.id.network_type_spinner);
    ...
    public void initializeSpinners() {
        ...
        // Array of Test Type options:
        String[] network_type_options = { "Wifi", "Cellular Network"};
        // Declaring an Adapter and initializing it to the data pump
        ArrayAdapter<String> networkType = new ArrayAdapter<String>(
                getApplicationContext(),R.layout.spinner_item ,network_type_options);
        networkType.setDropDownViewResource(R.layout.spinner_item);
        // Setting Adapter to the Spinner (dn and up)
        m_oNetworkTypeSpinner.setAdapter(networkType);
        m_oNetworkTypeSpinner.setSelection(0);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.task_runner_activity);
    ...
    /**
     * get m_sMode from spinner. return Constants.TCP_MODE
     ...
     * @return Time, Data
     */
    public int getNetworkTypeFromSpinner() {
        String chosenMode = (String) m_oNetworkTypeSpinner.getSelectedItem();
        if (chosenMode.equals("Wifi")) {
            return Constants.WIFI;
        } else { // Data
            return Constants.CELLULAR_NETWORK;
        }
    }
    /**
