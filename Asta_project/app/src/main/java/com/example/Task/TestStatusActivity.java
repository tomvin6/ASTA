...
public class TestStatusActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mode == Constants.FTP) {
            mModeStr = Constants.TCP_MODE;
        } else {
            mModeStr = Constants.UDP_MODE;
        }
    ...
    public void initialize() {
        // server
        m_tvMode = (TextView) findViewById(R.id.result_text);
        m_tvStatus = (TextView) findViewById(R.id.partner_port_text);
